...
const addToCart = (item) => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto mt-24 bg-gradient-to-b from-orange-50 to-white min-h-screen pb-20">
      {/* Page Title */}
...
{cartOpen && (
  ...
  >
    <div
      className="absolute right-0 top-0 h-full w-80 bg-white shadow-2xl p-5 overflow-y-auto animate-fadeSlideUp"
